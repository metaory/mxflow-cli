...
const defaultStartWorkflowPreCommands = {
  default__pre: [ 'git_fetch_origin', 'git_checkout_dev', 'git_merge_dev' ],
  feature__pre: [ 'git_fetch_origin', 'git_checkout_dev', 'git_merge_dev' ],
  bugfix__pre: [ 'git_fetch_origin', 'git_checkout_master', 'git_merge_master' ],
  hotfix__pre: [ 'git_fetch_origin', 'git_checkout_master', 'git_merge_master' ],
  flight__pre: [ 'git_fetch_origin', 'git_checkout_dev', 'git_merge_dev' ],
  other__pre: [ 'git_fetch_origin', 'git_checkout_master', 'git_merge_master' ]
}
...
export async function resetConfig() {
  ...
  $`rm -rf ${CONFIG_PATH}`
  log.redBox(chalk.yellow(icons.cross) + ' Config removed.')
}
