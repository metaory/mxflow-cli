  ...
  const config = {
    ...
    workflows: {
      foobar: {
        ...
        args: [
          { name: 'foo', type: 'string', default: 'fdef', export: 'foox' },
          { name: 'bar', type: 'string', default: 'bdef', export: 'barx' }
          // { name: 'MXF_BUG_TRACKER_NAME', type: 'env', default: 'jira', export: 'bugTrackerName' }
        ],
        steps: ['echo {foox} world', 'echo goodbye {barx} cruel world', 'confirm echo {barx} goodbye', 'echo "AWS_PROFILE: {AWS_PROFILE}"']
      }
    },
    ...sampleConfig
  }
